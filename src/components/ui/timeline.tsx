...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="max-w-7xl mx-auto text-center mb-16 w-full font-sans md:px-10 bg-gradient-to-br from-blue-50/30 via-purple-50/20 to-pink-50/30 dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900 dark:to-slate-950"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-muted-foreground text-sm md:text-base max-w-sm mx-auto">
          A step-by-step journey through how we bring your ideas to life.
        </p>
      </div>
